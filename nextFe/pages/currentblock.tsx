    ...
    <div className={styles.container}>
      ...
      <Menu/>
        ...
        <br/>
          ...
          Block Explorer made with <br/>
          Ethers.js, Next.js and  PostgreSQL.
          </h5>
        ...
        <Container className='table'>
          ...
          {blockData.data && blockData.data.rows.map( (transaction: { hash: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | ReactFragment | ReactPortal | null | undefined; blocknumber: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | ReactFragment | ReactPortal | null | undefined; sender: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | ReactFragment | ReactPortal | null | undefined; receiver: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | ReactFragment | ReactPortal | null | undefined; }, index: number) => {
            let link = `https://goerli.etherscan.io/tx/${transaction.hash}`
            return(<div key={index} className='row mx-1 grid'>
              <Col className={styles.card}>
            <p className='card-text grid-item'>Transaction hash: <b><Link href={link} target='_blank'><a target="_blank">{transaction.hash}</a></Link></b></p>
            <p className='card-text grid-item'>BlockNumber: <b>{transaction.blocknumber}</b></p>
            <p className='card-text grid-item'>Sender: <b>{transaction.sender}</b></p>
            <p className='card-text'>Receiver: <b>{transaction.receiver}</b></p>
            </Col>
          ...
          <div className='text-center '>
            <h2 className='text-white pt-2 pb-4'>Loading</h2>
            <svg id='spinningIcon' xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="white" className="bi bi-hypnotize" viewBox="0 0 16 16">
